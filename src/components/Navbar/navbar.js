...
const Logo = () => {
    return (React.createElement("a", { href: "#", className: "text-4xl font-semibold font-great-vibes" },
...
const NavLinks = () => {
    ...
    return (React.createElement("div", { className: "flex space-x-6 text-blue-400 font-shadows-into-light font-semibold text-xl" }, links.map((link) => (React.createElement("a", { href: link.url }, link.label)))));
};
